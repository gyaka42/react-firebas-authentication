    ...
    return (
        <div className="grid gap-y-10 mt-10">
            ...
            <div>
                ...
                <div className="mt-1">
                    <input type="text" className="block w-full rounded-md border-0 py-1.5 pl-7 pr-20 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" placeholder="Paste image Link" value={avatar} onChange={e => setAvatar(e.target.value)} />                </div>
            </div>
            <div>
            <button className="disabled:opacity-20 cursor-pointer bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mt-5" type="submit"> Guncelle </button>
            </div>
        </form>
        <form onSubmit={handleResetSubmit} className="grid gap-y-4">
            ...
            <div>
            <button disabled={!password} className="disabled:opacity-20 cursor-pointer bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mt-5" type="submit"> Sifreyi Guncelle </button>
            </div>
        </form>
        </div>
    )
